...
<body>
  <div class="ep-page">
    ...
    <section class="ep-stub" aria-label="Mesajlar">
      <p class="ep-stub-kicker">Mesajlar</p>
      <h1>Yakında burada</h1>
      <p class="ep-stub-lead">
        İlgilenen adaylarla platform üzerinden doğrudan yazışabileceğin kutu burada olacak. Şu an sessiz — ama ilk mesaj geldiğinde haberin olur.
      </p>
